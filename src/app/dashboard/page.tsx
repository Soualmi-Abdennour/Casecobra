...
async function Page() {
    ...
    if(!user || user.primaryEmailAddress?.emailAddress !== ADMIN_EMAIL) return notFound()
                ...
                <div className='flex flex-col gap-16'>
                    <div className='grid gap-4 sm:grid-cols-2'>
                        <Card>
                            ...
                            <CardFooter>
                                <Progress value={(lastWeekSum._sum.amount ?? 0) * 100 / WEEKLY_GOAL}></Progress>
                            </CardFooter>
                        </Card>
                        <Card>
                            <CardHeader className='pb-2'>
                            ...
                            <CardFooter>
                                <Progress value={(lastMonthSum._sum.amount ?? 0) * 100 / MONTHLY_GOAL}></Progress>
                            </CardFooter>
                        </Card>
                    </div>
