...
function OrderReceivedEmail({shippingAddress,orderId,orderDate}:{shippingAddress:ShippingAddress,orderId:string,orderDate:string}) {
    const baseUrl=process.env.NODE_ENV==="development"?"http://localhost:3000":"https://casecobra-sa.vercel.app"
    return (
        <Html>
            <Head></Head>
            ...
            <Body style={main}>
                <Container style={container}>
                    <Section style={message}>
                        <Img src={`${baseUrl}/snake-3.png`} width={65} height={73} alt='delivery snake' style={{margin:"auto"}}></Img>
                        <Heading style={global.heading}>Thank you for your order!</Heading>
                        <Text style={global.text}>
                            we are preparing everything for delivery and will notify you once your package has been shipped. Delivery usually takes 2 days.
                        </Text>
                    ...
                    <Section style={paddingY}>
                        <Row>
                            <Text style={{...footer.text,paddingTop:30,paddingBottom:30}}>
                                Please contact us if you have any questions. (If you reply to this email, we will not be able to see it.)
                            </Text>
                        </Row>
                        <Row>
